    ...
    return (  
        <div id="product" className="flex flex-col items-center justify-center min-h-screen px-5 bg-gray-100 xl:px-0">
            ...
            <div className="relative grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3 max-width">
                <Case title="Energie verte" description="Super ça utilise de l'energie verte" />
                <Case title="Super rapide" description="Ca fuse" />
                <Case title="Autre chose" description="Génial" />
            </div>
