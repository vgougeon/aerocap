...
const Case = (props) => {
    return (  
        <div className="col-span-1 pb-5 bg-white border border-gray-300 rounded">
            <h3 className="mx-4 mt-4 text-lg font-semibold tracking-wide">{ props.title }</h3>
    ...
    return (  
        <div id="product" className="flex flex-col items-center justify-center min-h-screen px-5 pb-12 overflow-hidden bg-gray-100 pt-52 xl:px-0">
            ...
            <div className="relative grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3 max-width">
                <Case title="Notre energie verte" description="Le moteur fonctionne à l'hydrogène et à l'énergie solaire, un bon moyen de réduire notre emprunte carbone." />
                <Case title="Vers l'infini et au delà !" description="A 500 mètres d'altitude, profitez du paysage tout autour de vous." />
                <Case title="A fond la capsule !" description="A plus de 200km/h , AeroCap vous assure un voyage rapide jusqu'à votre destination !" />
                ...
                <Case title="La sécurité avant tout" description="Des opérateurs surveilleront la capsule tout au long de la durée du voyage et pourront prendre le contrôle à distance en cas de nécessité." />
