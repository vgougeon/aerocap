...
export default async function helloAPI(req, res) {
  ...
  const result = await axios.get(`http://dev.virtualearth.net/REST/v1/Autosuggest?query=${req.query.place}&countryFilter=FR&maxResults=10&key=AqbL-5RHig7wP3r1UAN79qWen6TfUce6dtcCALCsMcn7-YxmUyaaUjzXA2Sjz4AW`)
